...
namespace Genesys.Internal.Provisioning.Api
{
    ...
    public interface IExportApi : IApiAccessor
    {
        ...
        ExportStatusResponse GetExportStatus (string id);
        ...
        ApiResponse<ExportStatusResponse> GetExportStatusWithHttpInfo (string id);
        ...
        System.Threading.Tasks.Task<ExportStatusResponse> GetExportStatusAsync (string id);
        ...
        System.Threading.Tasks.Task<ApiResponse<ExportStatusResponse>> GetExportStatusAsyncWithHttpInfo (string id);
    ...
    public partial class ExportApi : IExportApi
    {
        ...
        /// <param name="id">The ID of a previously started export.</param>
        /// <returns>ExportStatusResponse</returns>
        public ExportStatusResponse GetExportStatus (string id)
        {
        ...
        /// <param name="id">The ID of a previously started export.</param>
        /// <returns>ApiResponse of ExportStatusResponse</returns>
        public ApiResponse< ExportStatusResponse > GetExportStatusWithHttpInfo (string id)
        {
        ...
        /// <param name="id">The ID of a previously started export.</param>
        /// <returns>Task of ExportStatusResponse</returns>
        public async System.Threading.Tasks.Task<ExportStatusResponse> GetExportStatusAsync (string id)
        {
        ...
        /// <param name="id">The ID of a previously started export.</param>
        /// <returns>Task of ApiResponse (ExportStatusResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ExportStatusResponse>> GetExportStatusAsyncWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ExportApi->GetExportStatus");
