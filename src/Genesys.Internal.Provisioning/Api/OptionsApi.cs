...
namespace Genesys.Internal.Provisioning.Api
{
    ...
    public interface IOptionsApi : IApiAccessor
    {
        ...
        /// <param name="personDbid">The DBID of a person. Options are merged with the person&#39;s annex and the annexes of the person&#39;s agent groups. Mutual with agent_group_dbid. (optional)</param>
        /// <param name="agentGroupDbid">The DBID of an agent group. Options are merged with the agent group&#39;s annex. Mutual with person_dbid. (optional)</param>
        /// <param name="application">The name of an application. This value is set to CloudCluster by default. (optional)</param>
