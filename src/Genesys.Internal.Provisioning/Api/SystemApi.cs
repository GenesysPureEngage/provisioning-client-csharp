...
namespace Genesys.Internal.Provisioning.Api
{
    ...
    public interface ISystemApi : IApiAccessor
    {
        ...
        /// <returns></returns>
        void ExecuteServiceMethod (string serviceName, ServiceProxyData body);
        ...
        ApiResponse<Object> ExecuteServiceMethodWithHttpInfo (string serviceName, ServiceProxyData body);
        ...
        System.Threading.Tasks.Task ExecuteServiceMethodAsync (string serviceName, ServiceProxyData body);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> ExecuteServiceMethodAsyncWithHttpInfo (string serviceName, ServiceProxyData body);
    ...
    public partial class SystemApi : ISystemApi
    {
        ...
        /// <param name="body">Body data</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> ExecuteServiceMethodWithHttpInfo (string serviceName, ServiceProxyData body)
        {
