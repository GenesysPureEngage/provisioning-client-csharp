...
namespace Genesys.Internal.Provisioning.Model
{
    ...
    public partial class AddUserData :  IEquatable<AddUserData>, IValidatableObject
    {
        ...
        public AddUserData(AddUserDataData Data = default(AddUserDataData))
        {
            // to ensure "Data" is required (not null)
            if (Data == null)
            {
                throw new InvalidDataException("Data is a required property for AddUserData and cannot be null");
            }
            else
            {
                this.Data = Data;
        ...
        public AddUserDataData Data { get; set; }
