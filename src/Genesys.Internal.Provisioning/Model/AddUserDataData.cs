...
namespace Genesys.Internal.Provisioning.Model
{
    ...
    public partial class AddUserDataData :  IEquatable<AddUserDataData>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AddUserDataData);
        }

        /// <summary>
        /// Returns true if AddUserDataData instances are equal
        /// </summary>
        /// <param name="other">Instance of AddUserDataData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddUserDataData other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.CapacityRule == other.CapacityRule ||
                    this.CapacityRule != null &&
                    this.CapacityRule.Equals(other.CapacityRule)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CapacityRule != null)
                    hash = hash * 59 + this.CapacityRule.GetHashCode();
                return hash;
            }
        }
