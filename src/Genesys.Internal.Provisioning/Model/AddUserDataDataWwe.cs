...
namespace Genesys.Internal.Provisioning.Model
{
    ...
    public partial class AddUserDataDataWwe :  IEquatable<AddUserDataDataWwe>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as AddUserDataDataWwe);
        }

        /// <summary>
        /// Returns true if AddUserDataDataWwe instances are equal
        /// </summary>
        /// <param name="input">Instance of AddUserDataDataWwe to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddUserDataDataWwe input)
        {
            if (input == null)
                return false;
