...
namespace Genesys.Internal.Provisioning.Model
{
    ...
    public partial class ApiSuccessResponseStatus :  IEquatable<ApiSuccessResponseStatus>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as ApiSuccessResponseStatus);
        }

        /// <summary>
        /// Returns true if ApiSuccessResponseStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiSuccessResponseStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiSuccessResponseStatus input)
        {
            if (input == null)
                return false;
