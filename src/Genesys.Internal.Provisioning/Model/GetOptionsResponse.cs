...
namespace Genesys.Internal.Provisioning.Model
{
    ...
    public partial class GetOptionsResponse :  IEquatable<GetOptionsResponse>, IValidatableObject
    {
        ...
        public GetOptionsResponse(CreateUserSuccessResponseStatus Status = default(CreateUserSuccessResponseStatus), GetOptionsResponseData Data = default(GetOptionsResponseData))
        {
            this.Status = Status;
            this.Data = Data;
        }
