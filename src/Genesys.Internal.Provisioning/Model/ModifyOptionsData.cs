...
namespace Genesys.Internal.Provisioning.Model
{
    ...
    public partial class ModifyOptionsData :  IEquatable<ModifyOptionsData>, IValidatableObject
    {
        ...
        public ModifyOptionsData(ModifyOptionsDataData Data = default(ModifyOptionsDataData))
        {
            // to ensure "Data" is required (not null)
            if (Data == null)
            {
                throw new InvalidDataException("Data is a required property for ModifyOptionsData and cannot be null");
            }
            else
            {
                this.Data = Data;
        ...
        public ModifyOptionsDataData Data { get; set; }
