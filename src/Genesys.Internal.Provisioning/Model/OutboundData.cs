...
namespace Genesys.Internal.Provisioning.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OutboundData :  IEquatable<OutboundData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OutboundData" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="OutboundData" /> class.
        /// </summary>
        /// <param name="Name">Name of an outbound client  (required).</param>
        ...
        /// <param name="Type">SMTP or IMAP .</param>
        public OutboundData(string Name = default(string), string FromEmail = default(string), string Mailbox = default(string), string Password = default(string), string Host = default(string), int? Port = default(int?), string ConnectionSecurity = default(string), string Type = default(string))
        {
            // to ensure "Name" is required (not null)
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for OutboundData and cannot be null");
            }
            else
            {
                this.Name = Name;
        ...
        /// </summary>
        /// <value>Name of an outbound client </value>
        ...
        {
            return this.Equals(input as OutboundData);
        }

        /// <summary>
        /// Returns true if OutboundData instances are equal
        /// </summary>
        /// <param name="input">Instance of OutboundData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OutboundData input)
        {
            if (input == null)
                return false;
