...
namespace Genesys.Provisioning.Api
{
    ...
    public interface IExportApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Genesys.Provisioning.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">And export ID that was got previously.</param>
        /// <returns>GetExportStatusResponse</returns>
        GetExportStatusResponse GetExportStatus (decimal? id);
        ...
        /// <exception cref="Genesys.Provisioning.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">And export ID that was got previously.</param>
        /// <returns>ApiResponse of GetExportStatusResponse</returns>
        ApiResponse<GetExportStatusResponse> GetExportStatusWithHttpInfo (decimal? id);
        ...
        /// <exception cref="Genesys.Provisioning.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">And export ID that was got previously.</param>
        /// <returns>Task of GetExportStatusResponse</returns>
        System.Threading.Tasks.Task<GetExportStatusResponse> GetExportStatusAsync (decimal? id);
        ...
        /// <exception cref="Genesys.Provisioning.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">And export ID that was got previously.</param>
        /// <returns>Task of ApiResponse (GetExportStatusResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<GetExportStatusResponse>> GetExportStatusAsyncWithHttpInfo (decimal? id);
    ...
    public partial class ExportApi : IExportApi
    {
        ...
        /// <summary>
        /// Get export operation status The GET operation will check export status and returns percentage complete.
        /// </summary>
        /// <exception cref="Genesys.Provisioning.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">And export ID that was got previously.</param>
        /// <returns>GetExportStatusResponse</returns>
        public GetExportStatusResponse GetExportStatus (decimal? id)
        {
             ApiResponse<GetExportStatusResponse> localVarResponse = GetExportStatusWithHttpInfo(id);
             return localVarResponse.Data;
        }
        ...
        /// <param name="id">And export ID that was got previously.</param>
        /// <returns>ApiResponse of GetExportStatusResponse</returns>
        public ApiResponse< GetExportStatusResponse > GetExportStatusWithHttpInfo (decimal? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ExportApi->GetExportStatus");

            var localVarPath = "/export_users/{id}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            return new ApiResponse<GetExportStatusResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (GetExportStatusResponse) Configuration.ApiClient.Deserialize(localVarResponse, typeof(GetExportStatusResponse)));
        ...
        /// <param name="id">And export ID that was got previously.</param>
        /// <returns>Task of GetExportStatusResponse</returns>
        public async System.Threading.Tasks.Task<GetExportStatusResponse> GetExportStatusAsync (decimal? id)
        {
             ApiResponse<GetExportStatusResponse> localVarResponse = await GetExportStatusAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        /// <param name="id">And export ID that was got previously.</param>
        /// <returns>Task of ApiResponse (GetExportStatusResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetExportStatusResponse>> GetExportStatusAsyncWithHttpInfo (decimal? id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ExportApi->GetExportStatus");
