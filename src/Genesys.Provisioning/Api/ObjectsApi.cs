...
namespace Genesys.Provisioning.Api
{
    ...
    public interface IObjectsApi : IApiAccessor
    {
        ...
        /// <param name="groupType">Agent Group type if object_type &#x3D; &#39;agent-groups&#39;. (optional)</param>
        ...
        /// <param name="searchKey">A keypath in CFGDN or CfgAgentGroup to compare with search_term.  (optional)</param>
        /// <param name="matchMethod">Method to match the search_term (&#39;includes&#39;, &#39;startsWith&#39;, &#39;endsWith&#39;, &#39;isEqual&#39;).  (optional, default to includes)</param>
        /// <param name="sortKey">A keypath in CFGDN or CfgAgentGroup to sort by.  (optional)</param>
        /// <param name="sortAscending">&#39;true&#39; to sort ascenfing, &#39;false&#39; to sort descending.  (optional, default to true)</param>
        /// <param name="sortMethod">Case sensitive, case insensitive or numeric.  (optional, default to caseSensitive)</param>
        /// <returns>GetObjectsSuccessResponse</returns>
        GetObjectsSuccessResponse GetObject (string objectType, string dnType = null, string groupType = null, int? limit = null, int? offset = null, string searchTerm = null, string searchKey = null, string matchMethod = null, string sortKey = null, bool? sortAscending = null, string sortMethod = null);
        ...
        ApiResponse<GetObjectsSuccessResponse> GetObjectWithHttpInfo (string objectType, string dnType = null, string groupType = null, int? limit = null, int? offset = null, string searchTerm = null, string searchKey = null, string matchMethod = null, string sortKey = null, bool? sortAscending = null, string sortMethod = null);
        ...
        System.Threading.Tasks.Task<GetObjectsSuccessResponse> GetObjectAsync (string objectType, string dnType = null, string groupType = null, int? limit = null, int? offset = null, string searchTerm = null, string searchKey = null, string matchMethod = null, string sortKey = null, bool? sortAscending = null, string sortMethod = null);
        ...
        System.Threading.Tasks.Task<ApiResponse<GetObjectsSuccessResponse>> GetObjectAsyncWithHttpInfo (string objectType, string dnType = null, string groupType = null, int? limit = null, int? offset = null, string searchTerm = null, string searchKey = null, string matchMethod = null, string sortKey = null, bool? sortAscending = null, string sortMethod = null);
    ...
    public partial class ObjectsApi : IObjectsApi
    {
        ...
        /// <param name="sortMethod">Case sensitive, case insensitive or numeric.  (optional, default to caseSensitive)</param>
        /// <returns>GetObjectsSuccessResponse</returns>
        public GetObjectsSuccessResponse GetObject (string objectType, string dnType = null, string groupType = null, int? limit = null, int? offset = null, string searchTerm = null, string searchKey = null, string matchMethod = null, string sortKey = null, bool? sortAscending = null, string sortMethod = null)
        {
             ApiResponse<GetObjectsSuccessResponse> localVarResponse = GetObjectWithHttpInfo(objectType, dnType, groupType, limit, offset, searchTerm, searchKey, matchMethod, sortKey, sortAscending, sortMethod);
        ...
        /// <param name="sortMethod">Case sensitive, case insensitive or numeric.  (optional, default to caseSensitive)</param>
        /// <returns>ApiResponse of GetObjectsSuccessResponse</returns>
        public ApiResponse< GetObjectsSuccessResponse > GetObjectWithHttpInfo (string objectType, string dnType = null, string groupType = null, int? limit = null, int? offset = null, string searchTerm = null, string searchKey = null, string matchMethod = null, string sortKey = null, bool? sortAscending = null, string sortMethod = null)
        {
        ...
        /// <param name="sortMethod">Case sensitive, case insensitive or numeric.  (optional, default to caseSensitive)</param>
        /// <returns>Task of GetObjectsSuccessResponse</returns>
        public async System.Threading.Tasks.Task<GetObjectsSuccessResponse> GetObjectAsync (string objectType, string dnType = null, string groupType = null, int? limit = null, int? offset = null, string searchTerm = null, string searchKey = null, string matchMethod = null, string sortKey = null, bool? sortAscending = null, string sortMethod = null)
        {
             ApiResponse<GetObjectsSuccessResponse> localVarResponse = await GetObjectAsyncWithHttpInfo(objectType, dnType, groupType, limit, offset, searchTerm, searchKey, matchMethod, sortKey, sortAscending, sortMethod);
             return localVarResponse.Data;
        ...
        /// <param name="sortMethod">Case sensitive, case insensitive or numeric.  (optional, default to caseSensitive)</param>
        /// <returns>Task of ApiResponse (GetObjectsSuccessResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GetObjectsSuccessResponse>> GetObjectAsyncWithHttpInfo (string objectType, string dnType = null, string groupType = null, int? limit = null, int? offset = null, string searchTerm = null, string searchKey = null, string matchMethod = null, string sortKey = null, bool? sortAscending = null, string sortMethod = null)
        {
            // verify the required parameter 'objectType' is set
            if (objectType == null)
                throw new ApiException(400, "Missing required parameter 'objectType' when calling ObjectsApi->GetObject");
