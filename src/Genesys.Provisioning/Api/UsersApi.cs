...
namespace Genesys.Provisioning.Api
{
    ...
    public partial class UsersApi : IUsersApi
    {
        ...
        /// <summary>
        /// Create a new user The POST operation will create a new CfgPerson object in configuration server and configure related objects
        /// </summary>
        /// <exception cref="Genesys.Provisioning.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">Body Data</param>
        /// <returns>ApiSuccessResponse</returns>
        ...
        /// <summary>
        /// Get the logged in user The GET operation will fetch specified CfgPerson object  of the logged in user from configuration server
        /// </summary>
        /// <exception cref="Genesys.Provisioning.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>GetUsersSuccessResponse</returns>
