...
namespace Genesys.Provisioning.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AddUser :  IEquatable<AddUser>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="IsAgent">Specifies if the user is an agent. .</param>
        ...
        public AddUser(bool? ChangePasswordOnNextLogin = false, string EmailAddress = "test@email.com", string EmployeeID = "empid123", string ExternalID = "extid123", bool? Enabled = true, string UserName = "username123", string FirstName = "firstname123", string LastName = "lastname123", string LoginCode = default(string), string Password = "username123", List<string> PlaceNames = default(List<string>), bool? IsAgent = default(bool?), AddUserWwe Wwe = default(AddUserWwe), List<string> SwitchNames = default(List<string>), List<Extension> Phones = default(List<Extension>), bool? SupportSoftPhone = false, SipPhoneTypeEnum? SipPhoneType = SipPhoneTypeEnum.DISABLECTI, List<Skill> Skills = default(List<Skill>), List<string> AgentGroups = default(List<string>), List<string> AccessGroups = default(List<string>), int? VoiceMail = default(int?), string WrapUpTime = "123")
        {
            ...
            if (FirstName == null)
            {
                throw new InvalidDataException("FirstName is a required property for AddUser and cannot be null");
            }
            else
            {
            ...
            if (LastName == null)
            {
                throw new InvalidDataException("LastName is a required property for AddUser and cannot be null");
            }
            else
            {
            ...
            if (Password == null)
            {
                throw new InvalidDataException("Password is a required property for AddUser and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AddUser);
        }

        /// <summary>
        /// Returns true if AddUser instances are equal
        /// </summary>
        /// <param name="other">Instance of AddUser to be compared</param>
        /// <returns>Boolean</returns>
