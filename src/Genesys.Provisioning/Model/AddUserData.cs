...
namespace Genesys.Provisioning.Model
{
    ...
    public partial class AddUserData :  IEquatable<AddUserData>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="AddUserData" /> class.
        /// </summary>
        /// <param name="ChangePasswordOnNextLogin">if &#39;true&#39; (default &#39;false&#39;), user will be asked to change password on first login.  Effect: Controls the value of the corresponding CfgPerson attribute .</param>
        ...
        /// <param name="Folder">Folder where create a new user. If no folder is specified user will be created in a root folder  Effect: User, DNs, Places, AgentLogins etc will be created in a selected folder. .</param>
        /// <param name="UserName">User unique login.  Effect: Controls the value of the corresponding CfgPerson attribute  (required).</param>
        ...
        /// <param name="SupportSoftPhone">Enable SIP Phone, true/false (default &#39;false&#39;).  Effect: Writes corresponding information to the TServer annex of the created DNs (see sipPhoneType) .</param>
        ...
        public AddUserData(bool? ChangePasswordOnNextLogin = default(bool?), string EmailAddress = default(string), string EmployeeID = default(string), string ExternalID = default(string), bool? Enabled = default(bool?), string Folder = default(string), string UserName = default(string), string FirstName = default(string), string LastName = default(string), string LoginCode = default(string), string Password = default(string), List<string> PlaceNames = default(List<string>), bool? IsAgent = default(bool?), AddUserDataWwe Wwe = default(AddUserDataWwe), List<string> SwitchNames = default(List<string>), List<Extension> Phones = default(List<Extension>), bool? SupportSoftPhone = default(bool?), SipPhoneTypeEnum? SipPhoneType = default(SipPhoneTypeEnum?), List<Skill> Skills = default(List<Skill>), List<string> AgentGroups = default(List<string>), List<string> AccessGroups = default(List<string>), int? VoiceMail = default(int?), string WrapUpTime = default(string))
        {
        ...
        /// </summary>
        /// <value>if &#39;true&#39; (default &#39;false&#39;), user will be asked to change password on first login.  Effect: Controls the value of the corresponding CfgPerson attribute </value>
        ...
        /// </summary>
        /// <value>Folder where create a new user. If no folder is specified user will be created in a root folder  Effect: User, DNs, Places, AgentLogins etc will be created in a selected folder. </value>
        ...
        /// </summary>
        /// <value>Enable SIP Phone, true/false (default &#39;false&#39;).  Effect: Writes corresponding information to the TServer annex of the created DNs (see sipPhoneType) </value>
