...
namespace Genesys.Provisioning.Model
{
    ...
    public partial class AddUserDataWwe :  IEquatable<AddUserDataWwe>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Roles">WWE roles that will be added to the user. If isAgent &#x3D; true, ROLE_AGENT should present in this field. .</param>
        ...
        /// </summary>
        /// <value>WWE roles that will be added to the user. If isAgent &#x3D; true, ROLE_AGENT should present in this field. </value>
