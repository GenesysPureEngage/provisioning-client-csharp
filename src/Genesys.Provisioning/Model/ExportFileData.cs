...
namespace Genesys.Provisioning.Model
{
    ...
    public partial class ExportFileData :  IEquatable<ExportFileData>, IValidatableObject
    {
        ...
        public ExportFileData(List<string> Fields = default(List<string>), ExportFileDataFilterParameters FilterParameters = default(ExportFileDataFilterParameters), List<string> PersonDBIDs = default(List<string>), string FileName = "users.csv")
        {
