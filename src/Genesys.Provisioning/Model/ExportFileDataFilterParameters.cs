...
namespace Genesys.Provisioning.Model
{
    ...
    public partial class ExportFileDataFilterParameters :  IEquatable<ExportFileDataFilterParameters>, IValidatableObject
    {
        ...
        public ExportFileDataFilterParameters(string Subresources = "skills,devices", string Order = default(string), List<string> AgentGroupFilter = default(List<string>), List<string> SortBy = default(List<string>))
        {
