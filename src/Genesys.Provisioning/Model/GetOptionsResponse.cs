...
namespace Genesys.Provisioning.Model
{
    ...
    public partial class GetOptionsResponse :  IEquatable<GetOptionsResponse>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetOptionsResponse);
        }

        /// <summary>
        /// Returns true if GetOptionsResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of GetOptionsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetOptionsResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
