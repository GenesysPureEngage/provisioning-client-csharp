...
namespace Genesys.Provisioning.Model
{
    ...
    public partial class Login :  IEquatable<Login>, IValidatableObject
    {
        ...
        public Login(string DomainUsername = "domain.com\login", string Password = "password")
        {
            // to ensure "DomainUsername" is required (not null)
            if (DomainUsername == null)
            {
                throw new InvalidDataException("DomainUsername is a required property for Login and cannot be null");
            }
            else
            {
