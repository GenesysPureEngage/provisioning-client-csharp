...
namespace Genesys.Provisioning.Model
{
    ...
    public partial class ModifyOptionsData :  IEquatable<ModifyOptionsData>, IValidatableObject
    {
        ...
        /// <param name="Options">New application Options.  Effect: Replaces sections, keys and values in CloudCluster/Options  (required).</param>
        public ModifyOptionsData(string Application = default(string), Object Options = default(Object))
        {
        ...
        /// </summary>
        /// <value>New application Options.  Effect: Replaces sections, keys and values in CloudCluster/Options </value>
