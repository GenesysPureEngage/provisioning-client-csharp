...
namespace Genesys.Provisioning.Model
{
    ...
    public partial class UsersGetResponseStatusSuccessData :  IEquatable<UsersGetResponseStatusSuccessData>, IValidatableObject
    {
        ...
        public UsersGetResponseStatusSuccessData(List<Object> Users = default(List<Object>), Object User = default(Object), int? TotalCount = default(int?), List<UsersGetResponseStatusSuccessDataSkills> Skills = default(List<UsersGetResponseStatusSuccessDataSkills>))
        {
            this.Users = Users;
            this.User = User;
