...
namespace Genesys.Provisioning.Model
{
    ...
    public partial class UsersPut :  IEquatable<UsersPut>, IValidatableObject
    {
        ...
        public UsersPut(bool? ChangePasswordOnNextLogin = default(bool?), string EmailAddress = default(string), string EmployeeID = default(string), string ExternalID = default(string), bool? Enabled = default(bool?), string UserName = default(string), string FirstName = default(string), string LastName = default(string), string LoginCode = default(string), string Password = default(string), List<string> PlaceNames = default(List<string>), UsersPutWwe Wwe = default(UsersPutWwe), List<string> SwitchNames = default(List<string>), List<string> DeletedSwitchNames = default(List<string>), List<Extension> Phones = default(List<Extension>), bool? SupportSoftPhone = default(bool?), SipPhoneTypeEnum? SipPhoneType = default(SipPhoneTypeEnum?), List<Skill> Skills = default(List<Skill>), List<string> DeletedSkills = default(List<string>), List<string> AgentGroups = default(List<string>), List<string> DeletedAgentGroups = default(List<string>), List<string> AccessGroups = default(List<string>), List<string> DeletedAccessGroups = default(List<string>), int? VoiceMail = default(int?), string WrapUpTime = default(string))
        {
        ...
        public UsersPutWwe Wwe { get; set; }
        /// <summary>
