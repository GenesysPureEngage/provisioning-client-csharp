...
namespace Genesys.Provisioning.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UsersPutWwe :  IEquatable<UsersPutWwe>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersPutWwe" /> class.
        /// </summary>
        ...
        public UsersPutWwe(List<string> Roles = default(List<string>), List<string> DeletedRoles = default(List<string>))
        {
            this.Roles = Roles;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UsersPutWwe);
        }

        /// <summary>
        /// Returns true if UsersPutWwe instances are equal
        /// </summary>
        /// <param name="other">Instance of UsersPutWwe to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsersPutWwe other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
