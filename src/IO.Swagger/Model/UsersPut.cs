...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UsersPut :  IEquatable<UsersPut>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersPut" /> class.
        /// </summary>
        ...
        public UsersPut(bool? ChangePasswordOnNextLogin = default(bool?), string EmailAddress = default(string), string EmployeeID = default(string), string ExternalID = default(string), bool? Enabled = default(bool?), string UserName = default(string), string FirstName = default(string), string LastName = default(string), string LoginCode = default(string), string Password = default(string), string MultimediaPlaceName = default(string), List<string> PlaceNames = default(List<string>), List<string> Roles = default(List<string>), List<string> DeletedRoles = default(List<string>), List<string> SwitchNames = default(List<string>), List<string> DeletedSwitchNames = default(List<string>), List<Extension> Phones = default(List<Extension>), bool? SupportSoftPhone = default(bool?), SipPhoneTypeEnum? SipPhoneType = default(SipPhoneTypeEnum?), List<Skill> Skills = default(List<Skill>), List<string> DeletedSkills = default(List<string>), List<string> AgentGroups = default(List<string>), List<string> DeletedAgentGroups = default(List<string>), List<string> AccessGroups = default(List<string>), List<string> DeletedAccessGroups = default(List<string>), decimal? VoiceMail = default(decimal?), string WrapUpTime = default(string))
        {
            // to ensure "UserName" is required (not null)
            if (UserName == null)
            {
                throw new InvalidDataException("UserName is a required property for UsersPut and cannot be null");
            }
            else
            {
            ...
            if (FirstName == null)
            {
                throw new InvalidDataException("FirstName is a required property for UsersPut and cannot be null");
            }
            else
            {
            ...
            if (LastName == null)
            {
                throw new InvalidDataException("LastName is a required property for UsersPut and cannot be null");
            }
            else
            {
            ...
            if (Password == null)
            {
                throw new InvalidDataException("Password is a required property for UsersPut and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UsersPut);
        }

        /// <summary>
        /// Returns true if UsersPut instances are equal
        /// </summary>
        /// <param name="other">Instance of UsersPut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsersPut other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
